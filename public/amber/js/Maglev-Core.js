...
fn: function (){
var self=this;
smalltalk.send((typeof jQuery == 'undefined' ? nil : jQuery), "_getJSON_do_", [unescape("/ids"), (function(data){(function($rec){smalltalk.send($rec, "_persistentRootId_", [smalltalk.send(data, "_persistentRootId", [])]);smalltalk.send($rec, "_maglevSystemId_", [smalltalk.send(data, "_maglevSystemId", [])]);smalltalk.send($rec, "_defaultWorkspaceId_", [smalltalk.send(data, "_defaultWorkspaceId", [])]);return smalltalk.send($rec, "_evalObjectId_", [smalltalk.send(data, "_evalObjectId", [])]);})(self);smalltalk.send(smalltalk.send((smalltalk.MaglevObjectSpace || MaglevObjectSpace), "_instance", []), "_evalObject_", [smalltalk.send(smalltalk.send((smalltalk.MaglevObjectSpace || MaglevObjectSpace), "_instance", []), "_reloadObject_", [smalltalk.send(self, "_evalObjectId", [])])]);return smalltalk.send(self, "_openWindow_", [smalltalk.send(self, "_defaultWorkspaceId", [])]);})]);
return self;},
args: [],
source: unescape('ready%0A%09jQuery%20getJSON%3A%20%27/ids%27%20do%3A%20%5B%20%3Adata%20%7C%0A%09%09self%20persistentRootId%3A%20data%20persistentRootId%3B%0A%09%09%09maglevSystemId%3A%20data%20maglevSystemId%3B%0A%09%09%09defaultWorkspaceId%3A%20data%20defaultWorkspaceId%3B%0A%09%09%09evalObjectId%3A%20data%20evalObjectId.%0A%0A%09%09MaglevObjectSpace%20instance%20%0A%09%09%09evalObject%3A%20%28MaglevObjectSpace%20instance%20reloadObject%3A%20self%20evalObjectId%29.%0A%0A%09%09self%20openWindow%3A%20self%20defaultWorkspaceId.%0A%22%09%09self%20openWindow%3A%20self%20persistentRootId.%0A%09%09self%20openWindow%3A%20self%20maglevSystemId%20%22%20%5D.'),
messageSends: ["getJSON:do:", "persistentRootId:", "persistentRootId", "maglevSystemId:", "maglevSystemId", "defaultWorkspaceId:", "defaultWorkspaceId", "evalObjectId:", "evalObjectId", "evalObject:", "instance", "reloadObject:", "openWindow:"],
referencedClasses: ["MaglevObjectSpace"]
}),
smalltalk.Maglev.klass);
